...
class testTransH:
    ...
    def test_run(self,recordname):
        ...
        self.hit_20 = hits20 / len(self.test_triples)
        self.hit_10 = hits10 / len(self.test_triples)
        self.hit_1 = hits1 / len(self.test_triples)
        self.hit_3 = hits3 / len(self.test_triples)

        self.mean_rank = rank_sum /  len(self.test_triples)
        with codecs.open("weights_and_files/record", "a") as f2:
            print("写record")
            rtime = datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
            f2.write(recordname + "\thit_10:" + str(self.hit_10)+ "\thit_10:" + str(self.hit_10)+ "\thit_20:" + str(self.hit_20) + "\tmean_rank:" + str(self.mean_rank) +"\t" +rtime)
            f2.write("\n")
...
if __name__ == "__main__":
    ...
    entity, norm_relation, hyper_relation, test_triple = test_data_loader("weights_and_files/entity_dim50_nbatchs400_epoch40_loss1.027135",
    ...
    hit10,hit20, mean_rank = test.test_run(recordname)
